...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        /* ── PSG Academy button (inside container) ── */
        .psg-btn {{
            position: absolute; top: 8px; left: 8px; z-index: 10;
            padding: 6px 12px; background: #0C1C3E;
            border: 1px solid rgba(227,6,19,0.4); border-radius: 6px;
            color: #E30613; font-size: 10px; font-weight: 700; cursor: pointer;
            text-decoration: none; transition: all 0.25s;
            font-family: 'Montserrat', sans-serif; text-transform: uppercase;
            letter-spacing: 0.5px;
        }}
        .psg-btn:hover {{ background: rgba(227,6,19,0.15); color: #ff3040;
                           border-color: #E30613; }}
        ...
        @media (min-width: 900px) {{
            ...
            .psg-btn {{ font-size: 9px; padding: 5px 10px; }}
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <button class="admin-btn" id="admin-btn" title="Mode admin">\u2699</button>
        </div>
