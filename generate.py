...
<body>
    <div class="container">
        <!-- Corner buttons inside container -->
        ...
        <a href="/presences" class="corner-btn" style="position:absolute; top:8px; right:8px; z-index:10; background:rgba(12,28,62,0.9); color:#E30613; border-color:rgba(227,6,19,0.3);" title="Suivi des présences EDF">PSG Academy</a>
        <div class="header">
